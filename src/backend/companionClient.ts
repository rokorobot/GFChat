...
export class CompanionClient {
  ...
  async getAIResponse(
    ...
    console.log("[GF.Chat] companionClient runtimeMode:", runtimeMode);

    if (runtimeMode === 'local-preview') {
      console.log("[GF.Chat] using local mock response");
    ...
    console.log("[GF.Chat] calling Supabase Edge Function");
    try {
